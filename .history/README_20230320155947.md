...
- Applying scaling method (StandardScaler)
    - Logistic Regression on scaled dataset
        ...
        - Predicted probabilities
            - Convert probabilities to array of predictions 
- Function that predicts threshold
    - Classification report for different threshold using the probability output by logistic regression
